...
run("cat 3of3.flag.txt")
run("cat drop-in/1of3.flag.txt")
run("cat drop-in/instructions-to-2of3.txt")
run("find / -maxdepth 4 -name '*2of3*' 2>/dev/null")
run("find / -maxdepth 4 -name '*.flag.txt' 2>/dev/null")
